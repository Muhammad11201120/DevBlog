...
export default function Edit() {
    ...
    const form = useForm({ title: post.title, slug: post.slug, content: post.content, published_at: post.published_at ?? '' });
    ...
    return (
        <AppLayout>
            <form onSubmit={submit} className="mx-auto max-w-2xl space-y-4">
                ...
                <div>
                    <label className="block text-sm font-medium">Published At (optional)</label>
